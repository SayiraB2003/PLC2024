...
adsFromPlaylists = [item | item <- playlists, item <- item, isAdvert item] -- TASK 6.4(b)

shortItemLenghts1 = [item_length_secs | item_length_secs <- lengths1, item_length_secs < 20.0] -- TASK 6.4(a)
