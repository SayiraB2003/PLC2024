...
piecesFromThings = [piece for piece in things if isinstance(piece, Piece)] #TASK 6.3.(c) -- replace "todo" by a list comprehension
...
shortItemLenghts1 = [item for item in playlist1 if item.length_secs < 20.0 ] # TASK 6.3.(b) -- replace "todo" by a list comprehension
